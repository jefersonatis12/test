...
lyr_EsriWorldImagery_0.setVisible(true);lyr_GoogleSatellite_1.setVisible(true);lyr_SoterradoSanGermn_2.setVisible(true);lyr_PuenteLaIguan_3.setVisible(true);lyr_EstacinCaribe_4.setVisible(true);lyr_Inventario_T2_T3_2910_5.setVisible(true);lyr_inventarioT1_rev_pred_6.setVisible(true);lyr_LimiteIntervencinM80_7.setVisible(true);
var layersList = [lyr_EsriWorldImagery_0,lyr_GoogleSatellite_1,group_Soterreados,group_Puentes,group_Tramo1,group_PAF,lyr_LimiteIntervencinM80_7];
