...
var format_shp_PREDIOS_1 = new ol.format.GeoJSON();
var features_shp_PREDIOS_1 = format_shp_PREDIOS_1.readFeatures(json_shp_PREDIOS_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_shp_PREDIOS_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_shp_PREDIOS_1.addFeatures(features_shp_PREDIOS_1);
var lyr_shp_PREDIOS_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_shp_PREDIOS_1, 
                style: style_shp_PREDIOS_1,
                popuplayertitle: 'shp_PREDIOS',
                interactive: true,
    title: 'shp_PREDIOS<br />\
    <img src="styles/legend/shp_PREDIOS_1_0.png" /> Parcial<br />\
    <img src="styles/legend/shp_PREDIOS_1_1.png" /> Parcial <br />\
    <img src="styles/legend/shp_PREDIOS_1_2.png" /> Total<br />' });
...
var format_Inventario_T2_T3_2910_5 = new ol.format.GeoJSON();
var features_Inventario_T2_T3_2910_5 = format_Inventario_T2_T3_2910_5.readFeatures(json_Inventario_T2_T3_2910_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Inventario_T2_T3_2910_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Inventario_T2_T3_2910_5.addFeatures(features_Inventario_T2_T3_2910_5);
var lyr_Inventario_T2_T3_2910_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Inventario_T2_T3_2910_5, 
                style: style_Inventario_T2_T3_2910_5,
                popuplayertitle: 'Inventario_T2_T3_2910',
                interactive: true,
    title: 'Inventario_T2_T3_2910<br />\
    <img src="styles/legend/Inventario_T2_T3_2910_5_0.png" /> Conservación<br />\
    <img src="styles/legend/Inventario_T2_T3_2910_5_1.png" /> Tala<br />\
    <img src="styles/legend/Inventario_T2_T3_2910_5_2.png" /> Trasplante<br />' });
var format_inventarioT1_rev_pred_6 = new ol.format.GeoJSON();
var features_inventarioT1_rev_pred_6 = format_inventarioT1_rev_pred_6.readFeatures(json_inventarioT1_rev_pred_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_inventarioT1_rev_pred_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_inventarioT1_rev_pred_6.addFeatures(features_inventarioT1_rev_pred_6);
var lyr_inventarioT1_rev_pred_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_inventarioT1_rev_pred_6, 
                style: style_inventarioT1_rev_pred_6,
                popuplayertitle: 'inventarioT1_rev_pred',
                interactive: true,
    title: 'inventarioT1_rev_pred<br />\
    <img src="styles/legend/inventarioT1_rev_pred_6_0.png" /> Conservacion<br />\
    <img src="styles/legend/inventarioT1_rev_pred_6_1.png" /> Ninguno<br />\
    <img src="styles/legend/inventarioT1_rev_pred_6_2.png" /> Tala<br />\
    <img src="styles/legend/inventarioT1_rev_pred_6_3.png" /> Trasplante<br />' });
var format_LimiteIntervencinM80_7 = new ol.format.GeoJSON();
var features_LimiteIntervencinM80_7 = format_LimiteIntervencinM80_7.readFeatures(json_LimiteIntervencinM80_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LimiteIntervencinM80_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LimiteIntervencinM80_7.addFeatures(features_LimiteIntervencinM80_7);
var lyr_LimiteIntervencinM80_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LimiteIntervencinM80_7, 
                style: style_LimiteIntervencinM80_7,
                popuplayertitle: 'Limite Intervención M80',
                interactive: true,
                title: '<img src="styles/legend/LimiteIntervencinM80_7.png" /> Limite Intervención M80'
            });
var group_PAF = new ol.layer.Group({
                                layers: [lyr_Inventario_T2_T3_2910_5,lyr_inventarioT1_rev_pred_6,],
                                fold: 'open',
                                title: 'PAF'});
